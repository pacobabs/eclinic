...
const Delete = ({ patient, setUiState }: Props) => {
  return (
    <div className="fixed top-0 left-0 z-50 flex items-center justify-center w-screen h-screen origin-center bg-green-100 bg-opacity-50 bg-blur">
      ...
      >
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              ...
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Etes-vous sur(e) de vouloir supprimer ce patient ? Toutes les donnees sont supprimees de maniere
        ...
        <div className="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
          <button
            onClick={async () => {
              await DataStore.delete(patient)
              setUiState('list')
            }}
